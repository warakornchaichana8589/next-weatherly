...
const Breadcrumb = ({
  ...
  return (
    <>
      <div className="dark:bg-dark relative z-10 overflow-hidden pb-[60px] pt-[120px] md:pt-[130px] lg:lg:pt-40">
              ...
              <div className="text-center">
                ...
                <ul className="flex items-center justify-center gap-2.5">
                  <li>
                    <Link
                      href="/"
                      className="text-dark flex items-center gap-2.5 text-base font-medium dark:text-white"
                    >
                      Home
                    </Link>
                  </li>
                  <li>
                    <p className="text-gray-900 dark:text-white items-center gap-2.5 text-base font-medium">
